...
const producto4 = new Producto(1,'Nike Air Force One', 700000);
const producto5 = new Producto(2,'Apple Iphone 18 Pro Max', 12000000);
const producto6 = new Producto(3,'Macbook M1', 2600000);
